...
private:
    ...
    int hs_width,cu_width,cu_row,over_count;
...
public:
    HEAVYSEP(int memory, float ratio, float a, float b){
        hs_alpha = a;
        hs_beta = b;
    ...
    void Print_basic_info(){
        cout<<"HeavySep "<<endl;
        cout<<"hs memory: "<< hs_width*sizeof(CELL_node)*1.0/1024<<"KB"<<"\t array number: "<<hs_width
        <<"\t bucket number: " << hs_width * SLOT_NUM<<endl;
        cout<<"sketch memory: "<<cu_width*cu_row*10*1.0/1024/8<<"KB"<<endl;
    }
