...
public:
    ...
    void print_basic_info()
    {
        ...
        printf("\tSIMD buffer: %d counters, %.4lf KB occupies\n", bucket_num * counter_num, bucket_num * counter_num * 8.0  / 1024);
        printf("\tL1: %d counters, %.4lf KB occupies\n", w1, w1 * 0.5  / 1024);
        printf("\tL2: %d counters, %.4lf KB occupies\n", w2, w2 * 2.0  / 1024);
    }
